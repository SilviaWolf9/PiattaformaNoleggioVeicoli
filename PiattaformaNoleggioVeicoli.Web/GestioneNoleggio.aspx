...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-default" style="opacity:0.7">
        ...
        <div class="panel-body">
            ...
            <div class="form-group" runat="server" id="divVeicoloNonNoleggiato" visible="false" style="opacity:1">
                <p>
            ...
            <div class="form-group col-md-12" runat="server" id="divVeicoloNoleggiato" visible="false" style="opacity:1">
                <div class="col-md-4" style="opacity:1">
        ...
        <div class="panel-footer col-md-12" align="center" style="opacity:1">            
            ...
            <div align="center" class="col-md-12" style="opacity:1">
